...
class ChannelHelper:
    ...
    def getChannelData(self, channel, hours=1, start=None, end=None):
        """
        Retrieve the last hours (unless otherwise specified) worth of time, value pairs from the channel.
        
        Retrieves the last hours worth of time, value pairs from the passed channel.
        The time value pairs are returned as an array of two column NumPy array where the first
    ...
    def alignChannelData(self, *time_value_arrays):
        """
        ...
        *time_value_arrays : a variadic input of time array and value array tuples.
            example: alignChannelData((times1, data1), (times2, data2) ....)
